  ...
  return (
    <div className="cointainer min-w-[375px] py-[73px] px-[35px] lg:px-[165px] lg:py-[229px] bg-[#F6F5F6] sm:min-w-[647px] lg:h-full lg:min-w-[1114px] lg:flex lg:justify-center lg:items-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <section className="flex flex-col gap-4 bg-[#733FC8] p-8 rounded-lg sm:grid sm:col-span-2 sm:grid-flow-row">
          <div className="flex gap-[17px] items-center">
            ...
            <div className="hidden sm:flex ">
              <div className='sm:absolute left-104 lg:left-33'>
                  <img
        ...
        {/* JONATHAN */}
        <section className="flex flex-col gap-4 bg-[#48556A] p-8 rounded-lg">
          <div className="flex gap-[17px] items-center">
            <div>
              <img
        ...
        <section className="flex flex-col gap-4 bg-[#19202D] p-8 rounded-lg sm:grid sm:col-span-2">
          <div className="flex gap-[17px] items-center">
            ...
            <div className="flex flex-col gap-1">
              ...
              <h4 className="text-[11px]/[110%] text-white barlow-semi-condensed-medium">
                Verified Graduate
              </h4>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-4 bg-white p-8 rounded-lg sm:grid sm:col-span-2 lg:col-start-4 lg:row-start-1 lg:row-span-2">
          ...
          <div className="text-xl/[120%] text-[#48556A] barlow-semi-condensed-semibold max-w-[241px] sm:max-w-[583px]">
